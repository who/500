...
const validCommands: Record<string, unknown> = {
  ...
  convertSeatToBot: { t: 'convertSeatToBot', seat: 2, difficulty: 'hard' },
...
const malformedCommands: Record<string, unknown> = {
  ...
  configureBotsNotArray: { t: 'configureBots', bots: { seat: 1, difficulty: 'hard' } },
  configureBotsBadDifficulty: { t: 'configureBots', bots: [{ seat: 1, difficulty: 'expert' }] },
  configureBotsBadSeat: { t: 'configureBots', bots: [{ seat: 9, difficulty: 'hard' }] },
  // fh-4k3: the retired tiers must fail closed rather than seat a bot.
  configureBotsEasyTier: { t: 'configureBots', bots: [{ seat: 1, difficulty: 'easy' }] },
  configureBotsMediumTier: { t: 'configureBots', bots: [{ seat: 1, difficulty: 'medium' }] },
  convertSeatToBotBadSeat: { t: 'convertSeatToBot', seat: 4, difficulty: 'hard' },
  convertSeatToBotBadDifficulty: { t: 'convertSeatToBot', seat: 2, difficulty: 'expert' },
  convertSeatToBotMissingSeat: { t: 'convertSeatToBot', difficulty: 'hard' },
  convertSeatToBotEasyTier: { t: 'convertSeatToBot', seat: 2, difficulty: 'easy' },
  convertSeatToBotMediumTier: { t: 'convertSeatToBot', seat: 2, difficulty: 'medium' },
  bidMissing: { t: 'bid' },
